...
</li>`}const f=new u(".gallery a",{captionsData:"alt",captionDelay:250});function g(){s.gallery.classList.add("hidden"),s.loader.classList.remove("hidden")}function l(){s.loader.classList.add("hidden"),s.gallery.classList.remove("hidden")}function h(o){return f.refresh(),l(),o.map(m).join("")}const s={form:document.querySelector(".search-form"),input:document.querySelector("#input"),button:document.querySelector(".search-button"),gallery:document.querySelector(".gallery"),loader:document.querySelector(".loader-box")};new u(".gallery a",{captionsData:"alt",captionDelay:250});function y(o){const r="https://pixabay.com/api/",a={key:"49003886-a24f9c3a0fd607f8ed8b1fc56",q:o,image_type:"photo",orientation:"horizontal",safesearch:"true"};return d.get(r,{params:a}).then(({data:e})=>{if(e.hits.length===0)c.info({title:"No Results",message:"No images found for your search.",position:"topRight"});else{s.input.value="";const t=h(e.hits);s.gallery.innerHTML=t,l()}}).catch(e=>{l(),c.error({title:"Error",message:"❌ Error fetching images. Please try again!",position:"topRight"})})}s.form.addEventListener("submit",o=>{o.preventDefault();const r=o.target.elements.input.value.trim();if(g(),!r){c.error({title:"Error",message:"Please enter a search query.",position:"topRight"}),l();return}y(r)});
